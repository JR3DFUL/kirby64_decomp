...
#ifdef MIPS_TO_C
/* FACTORY: 246/369 with the instruction COUNT EXACT -- no missing or extra words, so
 * the residue is allocation/scheduling only. Best seed in this file; hand it to the
 * permuter before any of the short ones. */
